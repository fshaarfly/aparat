...
if (isset($_POST['verify_otp'])) {
  ...
  // Verifikasi OTP
  $query = "SELECT * FROM otp_lupa WHERE nomor = '$nomor' AND otp = '$otp_input'";
  $result = mysqli_query($db, $query);

  if (mysqli_num_rows($result) > 0) {
    $_SESSION['verified_user'] = $nomor; // Simpan status verifikasi
    $delete_query = "DELETE FROM otp_lupa WHERE nomor = '$nomor'";
    ...
    <div class="row corner box-area">
      <div class="col-lg-6 d-flex justify-content-center">
        <div class="row align-items-center mx-2 mx-sm-5" style="margin: 7rem 0">
          ...
          <h3 class="mt-n4">
            <a href="index.php" class="text-dark fw-bold">Masukkan Kode OTP Lupa Password Anda</a>
          </h3>
