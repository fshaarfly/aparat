        ...
        <div class="col-xxl-6 col-sm-12 mt-xxl-5 mt-sm-0">
          <a href="SKM.php">
            <div class="collapsible p-4" s>
              ...
              <p>Adalah surat keterangan yang menjelaskan mahasiswa berstatus Aktif mengikuti perkulihan di suatu semester.</p>
            </div>
          </a>
        </div>
        <div class="col-xxl-6 col-sm-12 mt-5">
          <a href="PKM.php">
            <div class="collapsible p-4" s>
              ...
              <p>Adalah pengajuan Kartu identitas yang menandakan seseorang mahasiswa sedang menempuh pendidikan di suatu perguruan tinggi.</p>
            </div>
          </a>
        </div>
        <div class="col-xxl-6 col-sm-12 mt-5">
          <a href="TAS.php">
            <div class="collapsible p-4" s>
              ...
              <p>Adalah Transkrip Akademik yang berisi Daftar Nilai Mata Kuliah yang telah diikuti oleh Mahasiswa dan Indek Prestasi Kumulatif (IPK).</p>
            </div>
          </a>
        </div>
        <div class="col-xxl-6 col-sm-12 mt-5">
          <a href="LKA.php">
            <div class="collapsible p-4" s>
              ...
              <p>Adalah akumulasi seluruh daftar nilai mahasiswa yang telah mengikuti Ujian Akhir Semester (UAS) dan Indeks Prestasi Kumulatif (IPK).</p>
            </div>
          </a>
        </div>
      </div>
